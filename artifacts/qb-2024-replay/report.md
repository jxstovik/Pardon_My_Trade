...
- Residual standard deviation: `7.911`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hard_stats | 78 | 45 | 89.463 | 114.046 | 33.369 | 0.346 | 0.417 | 0.765 |
| prior_baseline | 78 | 45 | 95.311 | 122.891 | 39.810 | 0.279 | 0.333 | 0.785 |
| razzball_rank | 0 | 45 | - | - | - | 0.713 | 0.500 | 0.815 |
| source_rank_blend | 0 | 45 | - | - | - | 0.539 | 0.500 | 0.830 |

## Takeaways

- The hard-stat model improved RMSE versus the historical baseline by `8.846` points.
- The hard-stat model's season bias was `33.369`; positive values indicate overprediction.
- Razzball rank Spearman correlation was `0.713` on `45` matched players.
- A separate rookie model was trained from `1049` prior-only rows; rookie uncertainty is widened, especially for QB.
